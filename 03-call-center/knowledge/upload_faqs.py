"""
Upload call center FAQs to Pinecone.
...
NAMESPACE = os.getenv("PINECONE_NAMESPACE", "biz_intern_callcenter")
...
print("Your call center bot can now answer customer queries using Pinecone.")
